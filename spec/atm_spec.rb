...
describe Atm do
  let(:account) { instance_double('Account', pin_code: '1234', exp_date: '08/20', account_status: :active) }
  ...
  it 'allow withdraw if accounts has enough balance. ' do
  ...
  it 'reject withdraw if account is disabled' do
    ...
    expect(subject.withdraw(25, '1234', account))
  end
end
